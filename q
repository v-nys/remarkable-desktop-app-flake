{
  ...
  outputs =
    ...
    let
      ...
      # I created the application folder by setting up Wine imperatively and running the installer
      # I then copied the files produced
      # for the prefix, I installed required DLL's via Winetricks
      # for the env variables, I checked the WineHQ DB
      shellSetup = ''
